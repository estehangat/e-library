                ...
                <div class="row">
                    <div class="table-responsive">
                        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            ...
                            <a class="m-0 float-right btn btn-brand-purple-dark btn-sm" href="/kependidikan/kbm/pelajaran/mata-pelajaran/tambah">Tambah <i class="fas fa-plus"></i></a>
                            @endif
                        </div>
                                ...
                                <tr>
                                    ...
                                    @if( in_array((auth()->user()->role_id), array(1,2,5)))
                                        ...
                                        @if( in_array((auth()->user()->role_id), array(1,2)))
                                            ...
                                            @if($mapel->jadwalPelajaran()->count()>0 || $mapel->skbmDetail()->count()>0)
                                            <Button href="#" class="btn btn-sm btn-danger" btn-danger" data-toggle="modal" data-target="#HapusModal{{ $mapel->id }}" disabled><i class="fas fa-trash"></i></Button>
                                            @else
                                            <Button href="#" class="btn btn-sm btn-danger" btn-danger" data-toggle="modal" data-target="#HapusModal{{ $mapel->id }}"><i class="fas fa-trash"></i></Button>
                                            @endif
                                        @endif
                                        </td>
                                    @endif
