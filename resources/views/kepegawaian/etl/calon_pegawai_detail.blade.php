    ...
    <div class="card">
      ...
      <div class="card-body bg-gray-200 p-4">
        <div class="d-flex align-items-center">
          ...
          <span class="mdi mdi-24px mdi-information text-info mr-2"></span>Calon civitas Auliya ini masih menunggu persetujuan Anda
          @else
          <span class="mdi mdi-24px mdi-check-circle text-success mr-2"></span>Rekomendasi calon civitas Auliya ini telah disetujui oleh {{ Auth::user()->pegawai->is($calon->accEdukasi) ? 'Anda' : $calon->accEdukasi->name }}
          @endif
        </div>
      </div>
      <div class="card-body p-4">
