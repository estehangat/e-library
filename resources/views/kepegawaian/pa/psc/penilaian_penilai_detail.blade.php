        ...
        <div class="card h-100">
            <div class="card-body p-0">
                <div class="row align-items-center mx-0">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('psc.penilaian.validator.index', ['tahun' => $tahun->academicYearLink, 'unit' => $unitAktif->name])}}" class="btn btn-sm btn-outline-brand-purple">Pilih</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table id="dataTable" class="table align-items-center table-flush">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('psc.penilaian.penilai.show', ['tahun' => $tahun->academicYearLink, 'unit' => $unitAktif->name, 'pegawai' => $p->nip]) }}" class="btn btn-sm btn-brand-purple-dark"><i class="fas fa-eye"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
