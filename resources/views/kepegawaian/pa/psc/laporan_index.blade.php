                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 col-12">
                   <div class="input-group">
                    ...
                    <a href="{{ route('psc.laporan.pegawai.index') }}" id="btn-select-year" class="btn btn-brand-purple ml-2 pt-2" data-href="{{ route('psc.laporan.pegawai.index') }}">Pilih</a>
                  </div>
                </div>
                </div>
              </div>
                ...
                <div class="col-md-6 col-12 mb-3">
                  <div class="row py-2 rounded border border-light mr-2">
                    ...
                    <div class="col-4 d-flex justify-content-end align-items-center">
                      <a href="{{ route('psc.laporan.pegawai.index', ['tahun' => $tahun->academicYearLink, 'unit' => $u->name])}}" class="btn btn-sm btn-outline-brand-purple-dark">Pilih</a>
                    </div>
                  </div>
                </div>
                @endforeach
