                                ...
                                <form action="/kependidikan/skhb/arsip/store" method="POST" enctype="multipart/form-data">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="m-0 float-right btn btn-brand-purple-dark btn-sm" href="/arsip/SKHB_{{$siswa->student_nis}}_{{$siswa->identitas->student_name}}.pdf">Unduh <i class="fas fa-download"></i></a>
                                            @else
                                            <div class="form-group row">
