                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="text-center">
                                        ...
                                        @else
                                        @if($siswas->unit_id == 1)
                                        <a href="{{ route('pas.cetak.laporantk',['id'=>$siswas->id])}}" class="btn btn-sm btn-brand-purple" target="_blank"><i class="fa fa-eye"></i> Pratinjau Rapor</a>
                                        @else
                                        <a href="{{ route('pas.cetak.laporan',['id'=>$siswas->id])}}" class="btn btn-sm btn-brand-purple" target="_blank"><i class="fa fa-eye"></i> Pratinjau Rapor</a>
                                        @endif
                                        @endif
                                    </td>
                                    @endif
