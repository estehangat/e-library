            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="form-group row kelas" style="display: none">
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                            <h6 class="font-weight-bold text-brand-purple">Semester Ajaran</h6>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <select name="tahun_ajaran" class="select2 form-control select2-hidden-accessible auto_width" id="kelas" style="width:100%;" tabindex="-1" aria-hidden="true" required="required">
                                    ...
                                    @foreach( $tahunAjaran as $index => $ta)
                                        <option id="semester_{{$index}}" value="{{ $ta->id }}" style="display: {{$index==2?'block':'none'}}" {{$index==2?'selected':''}}>{{ $ta->semester_id }} ({{$ta->semester}})</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                            <h6 class="font-weight-bold text-brand-purple">Informasi Alamat Calon Siswa</h6>
                            </div>
                        </div>
                        <div class="form-group row">
