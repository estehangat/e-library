                ...
                @if(Session::has('success'))
                  ...
                  @endif
                    <div class="row align-items-center">
                        <label class="col-md-3 col-xs-4">Memiliki Putra/i di Sekolah Lama?</label>
                    ...
                    <div id="nipd_siswa" class="row align-items-center" style="display:none">
                        ...
                        <div class="col-md-9 col-xs-6 wrap-input1005 validate-input m-b-10" data-validate="Masukkan No Pendaftaran">
                            <input class="input1005 select-exist" type="text" name="nipd" placeholder="NIPD Siswa Sekolah Lama">
                        </div>
                    </div>
                <div id="ortu">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-9 col-xs-6 wrap-input1005 validate-input m-b-10" data-validate="Masukkan No Pendaftaran">
                            <input class="input1005 select-new" type="text" name="father_name" placeholder="Nama Ayah" required="required">
                            <span class="focus-input1005"></span>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-9 col-xs-6 wrap-input1005 validate-input m-b-10" data-validate="Masukkan No Pendaftaran">
                            <input class="input1005 select-new" type="number" name="father_phone" placeholder="No HP Ayah" required="required">
                            <span class="focus-input1005"></span>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-9 col-xs-6 wrap-input1005 validate-input m-b-10" data-validate="Masukkan No Pendaftaran">
                            <input class="input1005 select-new" type="email" name="father_email" placeholder="Email Ayah (Menjadi Username Login)" required="required">
                            <span class="focus-input1005"></span>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-9 col-xs-6 wrap-input1005 validate-input m-b-10" data-validate="Masukkan No Pendaftaran">
                            <input class="input1005 select-new" type="text" name="mother_name" placeholder="Nama Ibu" required="required">
                            <span class="focus-input1005"></span>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-9 col-xs-6 wrap-input1005 validate-input m-b-10" data-validate="Masukkan No Pendaftaran">
                            <input class="input1005 select-new" type="number" name="mother_phone" placeholder="No HP Ibu" required="required">
                            <span class="focus-input1005"></span>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-9 col-xs-6 wrap-input1005 validate-input m-b-10" data-validate="Masukkan No Pendaftaran">
                            <input class="input1005 select-new" type="email" name="mother_email" placeholder="Email Ibu" required="required">
                            <span class="focus-input1005"></span>
                        </div>
                    </div>
                    <div class="row align-items-center">
                        <label class="col-md-12 col-xs-12">
                            Note :<br>1. Email Ayah menjadi username pada saat login<br>2. No. handphone Ibu akan dijadikan komunikasi dengan pihak sekolah via Whatsapp</label>
                    </div>
                </div>
