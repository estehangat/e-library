<div class="sidebar-heading">
    ...
    @if(in_array(Auth::user()->role->name,['kepsek','wakasek','etl','am']))
    ...
    @endif
    {{-- @if( in_array((auth()->user()->role_id), array(1,12,13,15,16,18,29,30,31,2,3)))
    ...
    @if( in_array((auth()->user()->role_id), array(1,7,12,13,15,16,18,29,30,31,2,3)))
    <li class="nav-item {{ (request()->is('kependidikan/kbm/siswa*')) ? 'active' : '' }}">
        ...
        <div id="collapseSiswaData" class="collapse {{ (request()->is('kependidikan/kbm/siswa*')) ? 'show' : '' }}" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item {{ (request()->is('kependidikan/kbm/siswa/aktif*')) ? 'active' : ''}}" href="/kependidikan/kbm/siswa/aktif">
                    <i class="mdi mdi-account-check" aria-hidden="true"></i>
                    <span>Aktif</span>
                </a>
                <a class="collapse-item {{ (request()->is('kependidikan/kbm/siswa/alumni*')) ? 'active' : '' }}" href="/kependidikan/kbm/siswa/alumni">
    ...
    @if( in_array((auth()->user()->role_id), array(1,5,12,15,16,2,3,29,30)))
    <li class="nav-item {{ (request()->is('kependidikan/kbm/kelas*')) ? 'active' : '' }}">
        ...
        <div id="collapseKelas" class="collapse {{ (request()->is('kependidikan/kbm/kelas*')) ? 'show' : '' }}" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                @if( in_array((auth()->user()->role_id), array(1,16,2)))
                <a class="collapse-item {{ (request()->is('kependidikan/kbm/kelas/daftar-kelas*')) ? 'active' : '' }}" href="/kependidikan/kbm/kelas/daftar-kelas">
                    <i class="mdi mdi-clipboard-list" aria-hidden="true"></i>
                    <span>Daftar Kelas</span>
                </a>
                @endif
                @if( in_array((auth()->user()->role_id), array(1,12,15,16,2,3,29,30)))
                <a class="collapse-item {{ (request()->is('kependidikan/kbm/kelas/pengajuan-kelas*')) ? 'active' : '' }}" href="/kependidikan/kbm/kelas/pengajuan-kelas">
                ...
                <a class="collapse-item {{ (request()->is('kependidikan/kbm/kelas/kelas-diampu*')) ? 'active' : '' }}" href="/kependidikan/kbm/kelas/kelas-diampu">
                    <i class="mdi mdi-clipboard-list" aria-hidden="true"></i>
                ...
                <a class="collapse-item {{ (request()->is('kependidikan/kbm/kelas/nama-kelas*')) ? 'active' : '' }}" href="/kependidikan/kbm/kelas/nama-kelas">
    ...
    @endif
    @if( in_array((auth()->user()->role_id), array(1,16,2,3,5)))
    <li class="nav-item {{ (request()->is('kependidikan/kbm/pelajaran*')) ? 'active' : '' }}">
        ...
        <div id="collapsePelajaran" class="collapse {{ (request()->is('kependidikan/kbm/pelajaran*')) ? 'show' : '' }}" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                @if( in_array((auth()->user()->role_id), array(1,16,2,3,5)))
                <a class="collapse-item {{ (request()->is('kependidikan/kbm/pelajaran/jadwal-pelajaran*')) ? 'active' : '' }}" href="/kependidikan/kbm/pelajaran/jadwal-pelajaran">
                    <i class="mdi mdi-calendar-multiple-check" aria-hidden="true"></i>
                    <span>Jadwal Pelajaran</span>
                </a>
                @endif
                <hr class="sidebar-divider">
                @if( in_array((auth()->user()->role_id), array(1,16,2)))
                <a class="collapse-item {{ (request()->is('kependidikan/kbm/pelajaran/kelompok-mata-pelajaran*')) ? 'active' : '' }}" href="/kependidikan/kbm/pelajaran/kelompok-mata-pelajaran">
                    <i class="mdi mdi-cog" aria-hidden="true"></i> 
                    <span>Kel. Mata Pelajaran</span>
                </a>
                @endif
                @if( in_array((auth()->user()->role_id), array(1,16,2,5)))
                <a class="collapse-item {{ (request()->is('kependidikan/kbm/pelajaran/mata-pelajaran*')) ? 'active' : '' }}" href="/kependidikan/kbm/pelajaran/mata-pelajaran">
                    <i class="mdi mdi-cog" aria-hidden="true"></i> 
                    <span>Mata Pelajaran</span>
                </a>
                @endif
                @if( in_array((auth()->user()->role_id), array(1,16,2,3)))
                <a class="collapse-item {{ (request()->is('kependidikan/kbm/pelajaran/waktu-pelajaran*')) ? 'active' : '' }}" href="/kependidikan/kbm/pelajaran/waktu-pelajaran">
                    <i class="mdi mdi-cog" aria-hidden="true"></i> 
    ...
    @endif
    @if( in_array((auth()->user()->role_id), array(1,15,16)))
