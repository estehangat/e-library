...
@section('sidebar-menu')
      ...
      <li class="nav-item {{ request()->routeIs('calon*') || request()->routeIs('pendidikanterakhir*') || request()->routeIs('programstudi*') || request()->routeIs('universitas*') ? 'active' : '' }}">
        ...
        <div id="collapseRekrutmen" class="collapse {{ request()->routeIs('calon*') || request()->routeIs('pendidikanterakhir*') || request()->routeIs('programstudi*') || request()->routeIs('universitas*') ? 'show' : '' }}" aria-labelledby="headingRekrutmen" data-parent="#accordionSidebar" style="">
